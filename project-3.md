...
- [ ] Add Project Manager(as stipulated in project 1 and 2) as collaborator on Github.
...
- [ ] Customize the template to your taste 
	- [ ] Update the title tag to match your name
	- [ ] Update the place holder content throughout the template to your information
		...
		* You can use sites like [https://www.pexels.com/](https://www.pexels.com/) for free images to fill in place holders and should not exceed file size of 150kb
...
- [ ] Host your website for the world to see using netlify or your choice service provider or github pages. Follow the instructions found here [https://pages.github.com/](https://pages.github.com/).  Once you have hosted your web page, share it for your peers to see.  This is not a small feat!
