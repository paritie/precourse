...
let numberOfOldCars = oldCars.length;
console.log("The following cars were made before year 2000 ->" + oldCars + " " + "and they are " + numberOfOldCars + " number of cars");
...
let BMWAndAudi =[];
function interest(make1, make2){
for (var i = 0; i < inventory.length; i++) {
    if(inventory[i].car_make === make1 ||
    inventory[i].car_make === make2){
    BMWAndAudi.push(inventory[i]);

                }
    }
return console.log(BMWAndAudi);
}
interest("BMW", "Audi");
