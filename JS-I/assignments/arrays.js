...
if(i==33){
	console.log("Car "+i+" is a "+inventory[i].car_year +" "+ inventory[i].car_make+" "+inventory[i].car_model );
...
for(i=0; i < oldCars.length; ++i){
console.log(oldCars[i]);
}
